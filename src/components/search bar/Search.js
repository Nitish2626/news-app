const Search = (props) => {
    ...
    return (
        <section className="w-full h-10 flex items-center justify-center fixed bg-white px-1 shadow-[2px_2px_10px_0px_black]">
            ...
            <input type="text" className="w-11/12 h-9 rounded-tl-md rounded-bl-md text-lg px-2 outline-none md:w-8/12 lg:w-6/12 3xl:w-4/12" placeholder={`Search for ${props.selected} news`} onChange={changeSearch} value={props.value}></input>
